...
function iknow_tm_portfolio_popup() {
  ...
  button.off().on("click", function () {
    ...
    modalBox
      .find(".popup_details")
      .prepend('<div class="top_image"><img src="img/thumbs/4-2.jpg" alt="" /><div class="main" data-img-url="' + image + '"></div></div>');
...
function iknow_tm_news_popup() {
  ...
  button.on("click", function () {
    ...
    modalBox
      ...
      .prepend('<div class="image"><img src="img/thumbs/4-2.jpg" alt="" /><div class="main" data-img-url="' + image + '"></div></div>');
